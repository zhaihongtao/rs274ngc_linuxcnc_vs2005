                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'a'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->a_flag), NCE_MULTIPLE_A_WORDS_ON_ONE_LINE);
                     ...
                     double *parameters)        //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != '/'), NCE_SLASH_MISSING_AFTER_FIRST_ATAN_ARGUMENT);
  *counter = (*counter + 1);
  CHKS_STR((line[*counter] != '['),
      NCE_LEFT_BRACKET_MISSING_AFTER_SLASH_WITH_ATAN);
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'b'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->b_flag), NCE_MULTIPLE_B_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->b_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'c'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->c_flag), NCE_MULTIPLE_C_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->c_flag = true;
                        ...
                        double *parameters)     //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != '('), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  (*counter)++;
                  ...
                  double *parameters)   //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != 'd'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->d_flag), NCE_MULTIPLE_D_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
                  ...
                  double *parameters)   //!< array of system parameters
{
  ...
  CHKS_STR((line[*counter] != '$'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->dollar_flag), NCE_MULTIPLE_$_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'e'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->e_flag), NCE_MULTIPLE_E_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->e_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != 'f'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->f_flag), NCE_MULTIPLE_F_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  CHKS_STR((value < 0.0), NCE_NEGATIVE_F_WORD_USED);
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'g'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  ...
  if ((value_read - value) > 0.999)
    ...
    ERS_STR(NCE_G_CODE_OUT_OF_RANGE);

  CHKS_STR((value > 999), NCE_G_CODE_OUT_OF_RANGE);
  CHKS_STR((value < 0), NCE_NEGATIVE_G_CODE_USED);
 ...
 remap_pointer r = _setup.g_remapped[value];
  if (r) {
      mode =  r->modal_group;
      CHKS_STR ((mode < 0),"BUG: G remapping: modal group < 0"); // real bad

      CHKS_STR((block->g_modes[mode] != -1),
	   NCE_TWO_G_CODES_USED_FROM_SAME_MODAL_GROUP);
      block->g_modes[mode] = value;
      return INTERP_OK;
  }
  mode = _gees[value];
  CHKS_STR((mode == -1), NCE_UNKNOWN_G_CODE_USED);
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'h'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->h_flag), NCE_MULTIPLE_H_WORDS_ON_ONE_LINE);
  CHP(read_integer_value(line, counter, &value, parameters));
  CHKS_STR((value < -1), NCE_NEGATIVE_H_WORD_USED);
  block->h_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'i'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->i_flag), NCE_MULTIPLE_I_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->i_flag = true;
                                 ...
                                 int *integer_ptr)      //!< pointer to the value being read              
{
  ...
  CHKS_STR((n == *counter), NCE_BAD_FORMAT_UNSIGNED_INTEGER);
  if (sscanf_s(line + *counter, "%d", integer_ptr) == 0)
    ERS_STR(NCE_SSCANF_FAILED);
  *counter = n;
  return INTERP_OK;
}
  ...
  *integer_ptr = (int) floor(float_value);
  if ((float_value - *integer_ptr) > 0.9999) {
    *integer_ptr = (int) ceil(float_value);
    ...
    ERS_STR(NCE_NON_INTEGER_VALUE_FOR_INTEGER);
  return INTERP_OK;
}
 ...
 /* Handle 'o', 'm98' and 'm99' sub return (but not 'm99' endless
    ...
    own commands and command handlers. */
  {
      ...
      for (; counter < length;) {
          ...
          else ERS_STR("Unexpected character after O-word");
      }
      return INTERP_OK;
  }
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'j'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->j_flag), NCE_MULTIPLE_J_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->j_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'k'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->k_flag), NCE_MULTIPLE_K_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->k_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'l'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->l_number > -1), NCE_MULTIPLE_L_WORDS_ON_ONE_LINE);
  CHP(read_integer_value(line, counter, &value, parameters));
  CHKS_STR((value < 0), NCE_NEGATIVE_L_WORD_USED);
                          ...
                          block_pointer block)        //!< pointer to a block being filled from the line 
{
  ...
  CHKS_STR(((line[*counter] != 'n') && (line[*counter] != 'o')),
      NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
                  ...
                  double *parameters)   //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != 'm'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHP(read_integer_value(line, counter, &value, parameters));
  CHKS_STR((value < 0), NCE_NEGATIVE_M_CODE_USED);

  remap_pointer r = _setup.m_remapped[value];
  if (r) {
      mode =  r->modal_group;
      CHKS_STR ((mode < 0),"BUG: M remapping: modal group < 0");
      CHKS_STR ((mode > 10),"BUG: M remapping: modal group > 10");

      CHKS_STR((block->m_modes[mode] != -1),
	   NCE_TWO_M_CODES_USED_FROM_SAME_MODAL_GROUP);
  ...
  CHKS_ONE((value > 199), NCE_M_CODE_GREATER_THAN_199,value);
  mode = _ems[value];
  CHKS_ONE((mode == -1), NCE_UNKNOWN_M_CODE_USED,value);
  CHKS_STR((block->m_modes[mode] != -1),
      NCE_TWO_M_CODES_USED_FROM_SAME_MODAL_GROUP);
  block->m_modes[mode] = value;
  block->m_count++;
  ...
  case 'a':
    if ((line[*counter] == 'n') && (line[(*counter) + 1] == 'd')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_A);
    break;
  case 'm':
    if ((line[*counter] == 'o') && (line[(*counter) + 1] == 'd')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_M);
    break;
  case 'o':
    if (line[*counter] == 'r') {
      ...
      *counter = (*counter + 1);
      ...
      ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_O);
    break;
  case 'x':
    if ((line[*counter] == 'o') && (line[(*counter) + 1] == 'r')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_X);
    break;
      ...
      if(line[*counter] == 'q')
	{
	  ...
	  *counter = (*counter + 1);
        ...
        ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_E);
      break;
    case 'n':
      if(line[*counter] == 'e')
	{
	  ...
	  *counter = (*counter + 1);
        ...
        ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_N);
      break;
    case 'g':
      if(line[*counter] == 'e')
	{
      ...
      else if(line[*counter] == 't')
	{
	  ...
	  *counter = (*counter + 1);
        ...
        ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_G);
      break;
    case 'l':
      if(line[*counter] == 'e')
	{
      ...
      else if(line[*counter] == 't')
	{
	  ...
	  *counter = (*counter + 1);
        ...
        ERS_STR(NCE_UNKNOWN_OPERATION_NAME_STARTING_WITH_L);
      break;

  case 0:
    ERS_STR(NCE_UNCLOSED_EXPRESSION);
  default:
    ERS_STR(NCE_UNKNOWN_OPERATION);
  }
  return INTERP_OK;
}
  ...
  case 'a':
    if ((line[*counter] == 'b') && (line[(*counter) + 1] == 's')) {
      ...
      *counter = (*counter + 3);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_A);
    break;
  case 'c':
    if ((line[*counter] == 'o') && (line[(*counter) + 1] == 's')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_C);
    break;
  case 'e':
    if ((line[*counter] == 'x') && (line[(*counter) + 1] == 'p')) {
      ...
      *operation = EXISTS;
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_E);
    }
    break;
  case 'f':
    if ((line[*counter] == 'i') && (line[(*counter) + 1] == 'x')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_F);
    break;
  case 'l':
    if (line[*counter] == 'n') {
      *operation = LN;
      *counter = (*counter + 1);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_L);
    break;
  case 'r':
    if (strncmp((line + *counter), "ound", 4) == 0) {
      ...
      *counter = (*counter + 4);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_R);
    break;
  case 's':
    if ((line[*counter] == 'i') && (line[(*counter) + 1] == 'n')) {
      ...
      *counter = (*counter + 3);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_S);
    break;
  case 't':
    if ((line[*counter] == 'a') && (line[(*counter) + 1] == 'n')) {
      ...
      *counter = (*counter + 2);
      ...
      ERS_STR(NCE_UNKNOWN_WORD_STARTING_WITH_T);
    break;
  default:
    ERS_STR(NCE_UNKNOWN_WORD_WHERE_UNARY_OPERATION_COULD_BE);
  }
  return INTERP_OK;
}
 ...
 double * parameters) /* array of system parameters                     */
{
  ...
  if (line[*counter] == 'm' &&
      ...
      // m98 or m99 found
      if (oNumber == 98) {
	  CHKS_STR(_setup.disable_fanuc_style_sub,
	  ...
	  *counter += 3;
	  ...
	  // context
	  strncpy_s(oNameBuf, _setup.sub_context[_setup.call_level].subName,
		  LINELEN+1);
      } else
	  // any other m-code should have been handled by read_m()
	  OERR_TWO(("%d: Bug:  Non-m98/m99 M-code passed to read_o(): '%s'"),
	       _setup.sequence_number, _setup.linetext);

  } else {
      CHKS_STR((line[*counter] != 'o'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
...
#define CMP(txt) (strncmp(line+*counter, txt, strlen(txt)) == 0 && (*counter += strlen(txt)))
  ...
  switch(block->o_type)
      ...
      else
	{
      ...
      sprintf_s(fullNameBuf, "%s#%s", subName, oNameBuf);
  ...
  if (block->o_type == O_sub || block->o_type == O_)
	...
	CHKS_STR((_setup.defining_sub == 1), NCE_NESTED_SUBROUTINE_DEFN);
    }
  // in terms of execution endsub and return do the same thing
      ...
      for(param_cnt=0;(line[*counter] == '[') || (line[*counter] == '(');)
	{
	  ...
	  logDebug("counter[%d] rest of line:|%s|", *counter,
		   line+*counter);
	  CHKS_STR((param_cnt >= INTERP_SUB_PARAMS),
  ...
  else
    {
      // not legal
      block->o_type = O_none;
      ERS_STR(NCE_UNKNOWN_COMMAND_IN_O_LINE);
    }
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'p'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->p_number > -1.0), NCE_MULTIPLE_P_WORDS_ON_ONE_LINE);
    ...
    char *nameBuf)   //!< pointer to name to be read
{
  ...
  *counter = (*counter + 1);
  ...
  CHKS_STR((!done), NCE_NAMED_PARAMETER_NOT_TERMINATED);
  ...
  *counter = (*counter + 1);
  ...
  else
  {
	  ...
	  *double_ptr = index >= 1 && index < RS274NGC_MAX_PARAMETERS;
      ...
      CHKS_STR(((index < 1) || (index >= RS274NGC_MAX_PARAMETERS)),
          NCE_PARAMETER_NUMBER_OUT_OF_RANGE);
      CHKS_STR(((index >= 5420) && (index <= 5428) && (_setup.cutter_comp_side)),
    ...
    bool check_exists)    //!< test for existence, not value
{
  CHKS_STR((line[*counter] != '['), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((line[*counter] != '#'), ("Expected # reading parameter"));
  CHP(read_parameter(line, counter, double_ptr, parameters, check_exists));
  CHKS_STR((line[*counter] != ']'), ("Expected ] reading bracketed parameter"));
  *counter = (*counter + 1);
  return INTERP_OK;
}
    ...
    double *parameters)   //!< array of system parameters
{
  ...
  *counter = (*counter + 1);
  ...
  else
  {
      ...
      CHKS_STR(((index < 1) || (index >= RS274NGC_MAX_PARAMETERS)),
          NCE_PARAMETER_NUMBER_OUT_OF_RANGE);
      CHKS_STR((isreadonly(index)), NCE_PARAMETER_NUMBER_READONLY);
      CHKS_STR((line[*counter] != '='),
          NCE_EQUAL_SIGN_MISSING_IN_PARAMETER_SETTING);
      *counter = (*counter + 1);
      CHP(read_real_value(line, counter, &value, parameters));
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'q'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->q_number > -1.0), NCE_MULTIPLE_Q_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  // FMP removed check for negatives, since we may want them for
  // user-defined codes
                  ...
                  double *parameters)   //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != 'r'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->r_flag), NCE_MULTIPLE_R_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->r_flag = true;
                            ...
                            double *double_ptr) //!< pointer to double to be read                  
{
  ...
  double val;
  if(!(s >> val)) ERS_ONE(("bad number format (conversion failed) parsing '%s'"), st.c_str());
  if(s.get() != std::char_traits<char>::eof()) ERS_ONE(("bad number format (trailing characters) parsing '%s'"), st.c_str());
                           ...
                           double *parameters)  //!< array of system parameters                    
{
  ...
  c = line[*counter];
  CHKS_STR((c == 0), NCE_NO_CHARACTERS_FOUND_IN_READING_REAL_VALUE);
  ...
  CHKS_STR(_isnan(*double_ptr),
          ("Calculation resulted in 'not a number'"));
  CHKS_STR((*double_ptr > 1000000000),
          ("Calculation resulted in 'infinity'"));//isinf
                  ...
                  double *parameters)   //!< array of system parameters                   
{
  ...
  CHKS_STR((line[*counter] != 's'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->s_flag), NCE_MULTIPLE_S_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  CHKS_STR((value < 0.0), NCE_NEGATIVE_SPINDLE_SPEED_USED);
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 't'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->t_flag), NCE_MULTIPLE_T_WORDS_ON_ONE_LINE);
  CHP(read_integer_value(line, counter, &value, parameters));
  CHKS_STR((value < 0), NCE_NEGATIVE_TOOL_ID_USED);
    ...
    int *length)       //!< a pointer to an integer to be set
{
  ...
  if (command == NULL) {
    if (fgets(raw_line, LINELEN, inport) == NULL) {
      ...
      {
        ERS_THR(("EOF in file:%s seeking o-word: o<%s> from line: %d"),
                 _setup.filename,
      ...
      {
        ERS_STR(NCE_FILE_ENDED_WITH_NO_PERCENT_SIGN);
      }
      else
      {
        ERS_STR(NCE_FILE_ENDED_WITH_NO_PERCENT_SIGN_OR_PROGRAM_END);
      }
    }
    ...
    CHKS_STR((strlen(command) >= LINELEN), NCE_COMMAND_TOO_LONG);
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'u'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->u_flag), ("Multiple U words on one line"));
  CHP(read_real_value(line, counter, &value, parameters));
  block->u_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'v'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->v_flag), ("Multiple V words on one line"));
  CHP(read_real_value(line, counter, &value, parameters));
  block->v_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'w'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->w_flag), ("Multiple W words on one line"));
  CHP(read_real_value(line, counter, &value, parameters));
  block->w_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'x'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->x_flag), NCE_MULTIPLE_X_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->x_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'y'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->y_flag), NCE_MULTIPLE_Y_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->y_flag = true;
                  ...
                  double *parameters)   //!< array of system parameters                    
{
  ...
  CHKS_STR((line[*counter] != 'z'), NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  *counter = (*counter + 1);
  CHKS_STR((block->z_flag), NCE_MULTIPLE_Z_WORDS_ON_ONE_LINE);
  CHP(read_real_value(line, counter, &value, parameters));
  block->z_flag = true;
