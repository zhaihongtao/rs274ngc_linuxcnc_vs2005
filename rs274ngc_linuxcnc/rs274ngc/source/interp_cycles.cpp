                              ...
                              double delta)      //!< size of z-axis feed increment   
{
  ...
  CHKS_STR((delta <= 0.0), NCE_NEGATIVE_OR_ZERO_Q_VALUE_USED);
                                 ...
                                 int motion, double dwell, int spindle)
{
   ...
   switch (direction) {
   case CANON_STOPPED:
      ERS_ONE(("Spindle not turning in G%c4"), op);
   case CANON_CLOCKWISE:
      CHKS_STR((motion == G_74), ("Spindle turning clockwise in G74"));
      break;
   case CANON_COUNTERCLOCKWISE:
       CHKS_STR((motion == G_84), ("Spindle turning counterclockwise in G84"));
    }
   ...
   switch (plane) {
    ...
    default:
       ERS_TWO("G%c4 for plane %s not implemented",
           op, plane_name(plane));
    }
...
{
  CHKS_STR(((direction != CANON_CLOCKWISE) &&
                         ...
                         setup_pointer settings)        //!< pointer to machine settings                   
{
  ...
  CHKS_STR((settings->feed_rate == 0.0), ("Cannot feed with zero feed rate"));
  CHKS_STR((settings->feed_mode == INVERSE_TIME), ("Cannot use inverse time feed with canned cycles"));
  CHKS_STR((settings->cutter_comp_side), ("Cannot use canned cycles with cutter compensation on"));
  ...
  if (!block->r_flag) {
    if (settings->motion_mode == motion)
      ...
      ERS_STR(NCE_R_CLEARANCE_PLANE_UNSPECIFIED_IN_CYCLE);
  }

  CHKS_STR((block->l_number == 0), NCE_CANNOT_DO_ZERO_REPEATS_OF_CYCLE);
  if (block->l_number == -1)
    block->l_number = 1;
  ...
  case CANON_PLANE_XZ:
  case CANON_PLANE_YZ:
    CHKS_ONE(block->u_flag, "Cannot put a U in a canned cycle in the %s plane",
	plane_name(settings->plane));
    CHKS_ONE(block->v_flag, "Cannot put a V in a canned cycle in the %s plane",
	plane_name(settings->plane));
    CHKS_ONE(block->w_flag, "Cannot put a W in a canned cycle in the %s plane",
	plane_name(settings->plane));
    break;
  ...
  case CANON_PLANE_VW:
  case CANON_PLANE_UW:
    CHKS_ONE(block->x_flag, "Cannot put an X in a canned cycle in the %s plane",
	plane_name(settings->plane));
    CHKS_ONE(block->y_flag, "Cannot put a Y in a canned cycle in the %s plane",
	plane_name(settings->plane));
    CHKS_ONE(block->z_flag, "Cannot put a Z in a canned cycle in the %s plane",
	plane_name(settings->plane));
  }
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->z_flag),
        _readers[(int)'z']? NCE_Z_VALUE_UNSPECIFIED_IN_XY_PLANE_CANNED_CYCLE: ("G17 canned cycle is not possible on a machine without Z axis"));
  }
  block->z_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    if(block->radius_flag)
        ...
        radius = _hypot(settings->current_y, settings->current_x);
    if(block->theta_flag)
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_Z_IN_CYCLE_IN_XY_PLANE);
  ...
  case G_81:
      ...
      break;
  case G_82:
    CHKS_STR(((settings->motion_mode != G_82) && (block->p_number == -1.0)),
        NCE_DWELL_TIME_P_WORD_MISSING_WITH_G82);
    block->p_number =
    ...
    break;
  case G_73:
    CHKS_STR(((settings->motion_mode != G_73) && (block->q_number == -1.0)),
    ...
    break;
  case G_83:
    CHKS_STR(((settings->motion_mode != G_83) && (block->q_number == -1.0)),
  ...
  case G_84:
      ...
      if (block->dollar_flag){
        CHKS_STR((block->dollar_number < 0 || block->dollar_number >= settings->num_spindles),
            (("Invalid spindle ($) number in G74/G84 cycle")));
  ...
  case G_85:
      ...
      break;
  case G_86:
    CHKS_STR(((settings->motion_mode != G_86) && (block->p_number == -1.0)),
        NCE_DWELL_TIME_P_WORD_MISSING_WITH_G86);
    block->p_number =
      block->p_number == -1.0 ? settings->cycle_p : block->p_number;
  ...
  case G_87:
    if (settings->motion_mode != G_87) {
      CHKS_STR((!block->i_flag), NCE_I_WORD_MISSING_WITH_G87);
      CHKS_STR((!block->j_flag), NCE_J_WORD_MISSING_WITH_G87);
      CHKS_STR((!block->k_flag), NCE_K_WORD_MISSING_WITH_G87);
    }
    ...
    break;
  case G_88:
    CHKS_STR(((settings->motion_mode != G_88) && (block->p_number == -1.0)),
        NCE_DWELL_TIME_P_WORD_MISSING_WITH_G88);
    block->p_number =
      block->p_number == -1.0 ? settings->cycle_p : block->p_number;
  ...
  case G_89:
    CHKS_STR(((settings->motion_mode != G_89) && (block->p_number == -1.0)),
        NCE_DWELL_TIME_P_WORD_MISSING_WITH_G89);
    block->p_number =
      block->p_number == -1.0 ? settings->cycle_p : block->p_number;
    ...
    break;
  default:
    ERS_STR(NCE_BUG_FUNCTION_SHOULD_NOT_HAVE_BEEN_CALLED);
  }
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->w_flag),
        _readers[(int)'w']? NCE_W_VALUE_UNSPECIFIED_IN_UV_PLANE_CANNED_CYCLE: ("G17.1 canned cycle is not possible on a machine without W axis"));
  }
  block->w_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_W_IN_CYCLE_IN_UV_PLANE);
  ...
  case G_84:
    ...
    if (block->dollar_flag){
        CHKS_STR((block->dollar_number < 0 || block->dollar_number >= settings->num_spindles),
            (("Invalid spindle ($) numberin G74/G84 cycle")));
        settings->active_spindle = (int)block->dollar_number;
    }
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->x_flag),
        _readers[(int)'x']? NCE_X_VALUE_UNSPECIFIED_IN_YZ_PLANE_CANNED_CYCLE: ("G19 canned cycle is not possible on a machine without X axis"));
  }
  block->x_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_X_IN_CYCLE_IN_YZ_PLANE);
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->u_flag),
        _readers[(int)'u']? NCE_U_VALUE_UNSPECIFIED_IN_VW_PLANE_CANNED_CYCLE: ("G19.1 canned cycle is not possible on a machine without U axis"));
  }
  block->u_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_U_IN_CYCLE_IN_VW_PLANE);
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->y_flag),
        _readers[(int)'y']? NCE_Y_VALUE_UNSPECIFIED_IN_XZ_PLANE_CANNED_CYCLE: ("G18 canned cycle is not possible on a machine without Y axis"));
  }
  block->y_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_Y_IN_CYCLE_IN_XZ_PLANE);
  ...
  case G_84:
     ...
     if (block->dollar_flag){
        CHKS_STR((block->dollar_number < 0 || block->dollar_number >= settings->num_spindles),
            (("Invalid E-number in G74/G84 cycle")));
        settings->active_spindle = (int)block->dollar_number;
     }
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS_STR((!block->v_flag),
        _readers[(int)'v']? NCE_V_VALUE_UNSPECIFIED_IN_UW_PLANE_CANNED_CYCLE: ("G18.1 canned cycle is not possible on a machine without V axis"));
  }
  block->v_number =
  ...
  if (settings->distance_mode == MODE_ABSOLUTE) {
    ...
    ERS_STR(NCE_BUG_DISTANCE_MODE_NOT_G90_OR_G91);
  CHKS_STR((r < cc), NCE_R_LESS_THAN_V_IN_CYCLE_IN_UW_PLANE);
